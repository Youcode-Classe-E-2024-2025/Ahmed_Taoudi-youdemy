<!-- Pagination -->
                <div class="flex justify-center mt-6">
                    <nav class="inline-flex rounded-md shadow-sm">
                        <!-- Previous Page Link -->
                        <?php if ($page > 1): ?>
                            <a href="?category=<?= isset($_GET['category']) ? htmlspecialchars($_GET['category']) : '' ?>&page=<?= $page - 1 ?>&search=<?= isset($_GET['search']) ? htmlspecialchars($_GET['search']) : '' ?>"
                        ...
                        <?php if ($totalPages <= 7): ?>
                            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                                <a href="?category=<?= isset($_GET['category']) ? htmlspecialchars($_GET['category']) : '' ?>&page=<?= $i ?>&search=<?= isset($_GET['search']) ? htmlspecialchars($_GET['search']) : '' ?>"
                        ...
                        <?php else: ?>
                            <!-- Show First Page -->
                            <a href="?category=<?= isset($_GET['category']) ? htmlspecialchars($_GET['category']) : '' ?>&page=1&search=<?= isset($_GET['search']) ? htmlspecialchars($_GET['search']) : '' ?>"
                            ...
                            <!-- Show Last Page -->
                            <a href="?category=<?= isset($_GET['category']) ? htmlspecialchars($_GET['category']) : '' ?>&page=<?= $totalPages ?>&search=<?= isset($_GET['search']) ? htmlspecialchars($_GET['search']) : '' ?>"
