    ...
    <aside id="sidebar" class="fixed top-16 left-0 z-20 flex flex-col flex-shrink-0 w-64 h-[calc(100%-4rem)] pt-4 duration-75 bg-white border-r transition-width lg:translate-x-0 -translate-x-full">
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            ...
            <div class="flex-1 px-3 space-y-1">
                <a href="/student/dashboard" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-emerald-100 group">
                    <i class="ri-dashboard-line text-xl text-gray-500 group-hover:text-emerald-600"></i>
                    <span class="ml-3">Tableau de bord</span>
                </a>
                <a href="/student/courses" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-emerald-100 group">
                    <i class="ri-book-line text-xl text-gray-500 group-hover:text-emerald-600"></i>
                    <span class="ml-3">Catalogue des cours</span>
                </a>
                <a href="/student/my-courses" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-emerald-100 group">
                    <i class="ri-folder-line text-xl text-gray-500 group-hover:text-emerald-600"></i>
                    <span class="ml-3">Mes cours</span>
                </a>
                <a href="/student/certificates" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-emerald-100 group">
